            ...
            <div className="px-4 sm:px-8 lg:w-1/2 xl:pr-16">
              ...
              <div className="mt-10 sm:flex sm:justify-center lg:justify-start">
                <div className="rounded-md shadow">
                  <Link href={"/products"}>
                    <button className="flex w-full items-center justify-center rounded-md border border-transparent bg-blue-600 px-8 py-3 text-sm font-medium text-white hover:bg-indigo-700 md:py-4 md:px-10 md:text-lg">
