      ...
      <div className="bg-white">
        <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
          <div className="max-w-xl">
            <h1 className="font-Inter text-base font-medium text-indigo-600">
              {myOrder?.language === "English" ? "Thank You!" : "Gracias!"}
            </h1>
            <p className="mt-2 font-Jakarta text-4xl font-bold tracking-tight sm:text-5xl">
              {myOrder?.language === "English"
                ? "Request Sent!"
                : "¡Solicitud Enviada!"}
            </p>
            <p className="mt-2 font-Inter text-base text-gray-500">
              {myOrder?.language === "English"
            ...
            {myOrder?.products.map((product) => (
              ...
              >
                ...
                <div className="flex flex-auto flex-col">
                  <div>
                    <h4 className="font-Jakarta font-medium text-gray-900">
                      {myOrder.language === "English"
                        ? product.titleEng
                        : product.titleEsp}
                    </h4>
            ...
            <div className="sm:ml-40 sm:pl-6">
              ...
              <dl className="grid grid-cols-2 gap-x-6 py-10 text-sm">
                <div>
                  ...
                  <dd className="mt-2 font-Inter text-gray-700">
              ...
              <dl className="space-y-6 border-t border-gray-200 pt-10 text-sm">
                <div className="flex justify-between">
                  ...
                  <dd className="font-Jakarta text-gray-900">
                    $ {myOrder?.total}
                  </dd>
                </div>
              </dl>
          ...
          <Link href={"/products"}>
            <button
              type="button"
              className="mt-12 inline-flex w-full items-center justify-center rounded-md border border-transparent bg-indigo-100 px-4 py-2 font-Inter text-sm font-medium text-indigo-700 hover:bg-indigo-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
            >
              {myOrder?.language === "English"
                ? "Keep Shopping"
                : "Seguir comprando"}
